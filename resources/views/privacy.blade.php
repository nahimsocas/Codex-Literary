...
@section('css, javascript')
    <link href="{{ asset('css/terms-privacy.css') }}" rel="stylesheet">
@endsection

@section('content')
    <main id="terms-privacy--main">
        <section id="terms_privacy">
            <aside id="list_tree">
                <ul>
                    <li>
                        <a href="#privacy_h1">Privacy Policy for Codex Literary</a>
                    </li>
                    <ol>
                        <li>
                            <a href="#privacy_h2-first">Consent</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-second">Information we collect</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-third">How we use your information</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-fourth">Log Files</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-fifth">Cookies and Web Beacons</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-sixth">Google DoubleClick DART Cookie</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-seventh">Our Advertising Partners</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-eigth">Advertising Partners Privacy Policies</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-ninth">Third Party Privacy Policies</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-tenth">CCPA Privacy Rights</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-eleventh">GDPR Data Protection Rights</a>
                        </li>
                        <li>
                            <a href="#privacy_h2-twelve">Children's Information</a>
                        </li>
                    </ol>
                </ul>
            </aside>
            <section id="tree_info">
                <h1 id="privacy_h1">Privacy Policy for Codex Literary</h1>
                <p>
                    At Codex Literary, accessible from codexliterary.com, one of our main priorities is the privacy of our visitors. 
                    This Privacy Policy document contains types of information that is collected and recorded by Codex Literary and how 
                    we use it.
                </p>
                <p>
                ...
                <p>
                    ...
                    the information that they shared and/or collect in Codex Literary. This policy is not applicable to any information 
                    collected offline or via channels other than this website.
                </p>

                <h2 id="privacy_h2-first">Consent</h2>
                <p>
                    By using our website, you hereby consent to our Privacy Policy and agree to its terms.
                </p>

                <h2 id="privacy_h2-second">Information we collect</h2>
                <p>
                ...
                <h2 id="privacy_h2-third">How we use your information</h2>
                <p>
                ...
                <h2 id="privacy_h2-fourth">Log Files</h2>
                <p>
                    Codex Literary follows a standard procedure of using log files. These files log visitors when they visit websites. 
                ...
                <h2 id="privacy_h2-fifth">Cookies and Web Beacons</h2>
                <p>
                    Like any other website, Codex Literary uses 'cookies'. These cookies are used to store information including 
                ...
                <h2 id="privacy_h2-sixth">Google DoubleClick DART Cookie</h2>
                <p>
                    ...
                    at the following URL – <a href="https://policies.google.com/technologies/ads">Google Ads</a>
                </p>

                <h2 id="privacy_h2-seventh">Our Advertising Partners</h2>
                <p>
                ...
                <h2 id="privacy_h2-eigth">Advertising Partners Privacy Policies</h2>
                <p>
                    You may consult this list to find the Privacy Policy for each of the advertising partners of Codex Literary.
                </p>
                <p>
                    Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used 
                    in their respective advertisements and links that appear on Codex Literary, which are sent directly to users' 
                    ...
                    effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on 
                     id="privacy_h2-fifth"websites that you visit.
                </p>
                <p>
                    Note that Codex Literary has no access to or control over these cookies that are used by third-party advertisers.
                </p>

                <h2 id="privacy_h2-ninth">Third Party Privacy Policies</h2>
                <p>
                    Codex Literary's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult 
                ...
                <h2 id="privacy_h2-tenth">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                <p>
                ...
                <h2 id="privacy_h2-eleventh">GDPR Data Protection Rights</h2>
                ...
                <h2 id="privacy_h2-twelve">Children's Information</h2>
                <p>
                ...
                <p>
                    Codex Literary does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think 
